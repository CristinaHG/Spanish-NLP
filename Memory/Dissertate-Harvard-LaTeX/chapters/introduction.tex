...
A diferencia de la técnica anterior, \citet{yu2003towards} presentaron un trabajo en el que se clasificaba la frase en objetiva o subjetiva, pero también la orientación de las frases subjetivas(positiva,negativa o neutral). Para la primera, los autores presentan resultados para  \txtsf{detección de similaridad en oraciones}, \textsf{naive bayes} y \textsf{naive bayes multiclase}. Para la segunda tarea, emplean una técnica similar a la de \citet{turney2002thumbs}.  
