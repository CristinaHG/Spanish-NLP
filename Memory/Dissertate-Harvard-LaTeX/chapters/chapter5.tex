...
\end{minted} mapea las etiquetas del tagset \textsc{parole} a \textsc{pennTreebank}
...
\end{minted} mapea las etiquetas de \textsc{pennTreebank} al  \textsc{universal} y
\begin{minted}
[frame=lines,
framesep=1.3mm,
fontsize=\footnotesize,
...
\end{minted} mapea de \textsc{parole} al  \textsc{universal}.
