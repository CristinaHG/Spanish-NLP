...
\end{savequote}
%\\[\baselineskip]
En esta parte del trabajo se detalla el desarrollo del trabajo. La resolución del trabajo se divide de la siguiente manera:
\begin{itemize}
\item En el \textcolor{SchoolColor}{Capítulo 3} se hace una introducción a Scala, para visualizar el porqué de su elección.
\item En el \textcolor{SchoolColor}{Capítulo 4} se habla de como se ha planificado el proyecto, análisis de requisitos, diseño y metodología de desarrollo. 
\item En el \textcolor{SchoolColor}{Capítulo 5} se explica el material empleado para la resolución de este trabajo, corpus de datos, ficheros para el contexto, el léxico o la morfología...
\item En el \textcolor{SchoolColor}{Capítulo 6} se detalla el proceso de implementación y pruebas de los algoritmos desarrollados.
\end{itemize}
