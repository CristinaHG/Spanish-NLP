...
A continuación se expone mediante un \textcolor{SchoolColor}{diagrama de Gantt} como se ha distribuido el tiempo durante estos 5 meses para cada tarea de este proyecto.
\\[\baselineskip]
...
\ganttbar{Revisión bibliográfica}{3}{9} \\
\ganttlinkedbar[link type=f-s]{Análisis de requisitos y diseño}{10}{10}\\
\ganttlinkedbar[link type=f-s]{Impl. y eval. Del Tokenizador}{11}{15}\\
\ganttlinkedbar[link type=f-s]{Impl. y eval. Del POS Tagger}{16}{20}\\
\ganttlinkedbar[link type=f-s]{Impl. y eval. Del Lematizador}{21}{25}\\
