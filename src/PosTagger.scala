...
class PosTagger {
  ...
  def find_tags(tokens:mutable.MutableList[String], lexicon:Lexicon, model:String, morphology:Morphology, context:Context, entities:String, default:List[String],
